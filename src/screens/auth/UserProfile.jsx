      ...
      <section className="shadow-s1 p-8 rounded-lg">
        <div className="profile flex items-center gap-8">
          ...
          <div>
            ...
            <Caption>guest@gmail.com</Caption>
          </div>
        </div>
        <form>
          <div className="flex items-center gap-5 mt-10">
            <div className="w-full">
              ...
              <input type="search" className={`capitalize ${commonClassNameOfInput}`} placeholder="Guest" readOnly />
            </div>
          </div>
          <div className="flex items-center gap-5 mt-10">
            <div className="w-1/2">
            ...
            <div className="w-1/2">
              ...
              <input type="search" className={commonClassNameOfInput} placeholder="guest@gmail.com" disabled />
            </div>
          </div>
          <div className="my-8">
          ...
          <div className="my-8">
            ...
            <input type="search" className={commonClassNameOfInput} placeholder="Upload" required />
          </div>
