        ...
        <Container className="flex items-center justify-between md:flex-row flex-col">
          <div className="w-full md:w-1/2 text-white pr-12">
            ...
            <Body className="leading-7 text-gray-200 my-8">
              Welcome to BidOut, the ultimate online bidding platform where you can discover exclusive products and services at unbeatable prices. Whether you're a casual shopper or a seasoned bidder, our easy-to-use interface allows you to explore live auctions, place competitive bids, and win incredible items across a wide range of categories. 
            </Body>
            <SearchBox />
          ...
          <div className="w-full md:w-1/2 my-16 relative py-16">
            ...
            <div className="horiz-move absolute md:top-28 top-8 left-0">
              <Box title="Proof of quality" desc="Bid Smart, Win Big!" />
            </div>
            <div className="horiz-move absolute bottom-72 right-0">
              <Box title="Safe and secure" desc="Discover, Bid, and Win Big Deals Today!" />
            </div>
