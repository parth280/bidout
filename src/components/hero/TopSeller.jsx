  ...
  return (
    <>
      <section className="process py-12">
        <Container>
          <Heading title="Top Seller" subtitle="Unlock the highest value for your card with our top-rated auction platform. Join thousands of satisfied sellers and get the best offers effortlessly!" />
